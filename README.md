...
<p align="center">
  <img src="docs/screenshot.png" alt="字己首页截图" width="85%"><br>
  <sub>字己首页截图</sub>
</p>
...
### 关于字己
字己是一款坚持**本地优先**的个人文字档案。希望用极简的形式和沉浸感，打造一个以记录为目的的纯文字写作应用。通过记录，用文字认识自己，也在回看中自我观察和自我治愈。
...
为了回答这个问题，我亲手摘掉了社会面具，不再把重心放在做好员工、做好女儿等角色上。我花了 3 年直面它——这 3 年，我对这个问题的执着几乎摧毁了我。我做了一切可能帮我找到答案的事情：裸辞学滑雪冲浪、兴趣社交、旅游、体验、阅读、学习紫薇斗数、易经、占星，从哲学、心理学、玄学各种领域中寻找答案。同时，每当这个问题浮现，我都会用文字写下来，记录脑中的一切声音。

直到半年前，我才发现：**我一直都在**。那个妈妈的好女儿、公司的好员工、那个承担社会角色和不愿意承担角色的人都是我；那个像孩子一样蹲在路边看野花的人是我；那个理性面对未来的人是我；那个深夜怀疑存在感的人也是我。

我从自己的文字中发现怀疑、沮丧、空虚，也发现感恩、温暖和治愈。**写下来救了我，它在我和敏感的头脑之间创造了呼吸的空间，它打开了一条裂缝，让光照了进来。**

### 关于写作
说到写作，我们常会联想到一部完整的作品和优美的文字，但我认为这是我们制造的门槛。

每个人都有能力、也有权利进行自我的写作。不需要文字功底，不需要语言优美，只需要你用自己的话，表达出真实的你、你的想法、你的感受、你的自我怀疑与自我肯定。所有的这些文字，将勾勒出一个完整的你。
...
应用本身只是一个工具和桥梁，AI也是工具，核心资产是你的数据。你的数据随时可以连接到其他工具，无需导出。在 AI 普及的当下，这种形式反而让我感到安全：你可以自由选择是否向 AI 暂时分享你的数据（用于帮你结构化地理解自己，或从外部写入数据），用法灵活，且**全由你个人控制**。
...
- **数据自由，无限延伸**：你可以任意备份，也可以借助第三方md笔记工具比如obsiden或个人 AI 分析文字并回存，发现被忽视的课题与自我美好的一面。
...
产品名称「字己 / ZiJi」、官方 Logo 图形标识、所有界面设计、文字内容、视觉资产及程序逻辑均享有在先原创版权与专有权益保护。请尊重原创劳动，未经作者书面许可，请勿抄袭、冒用、反编译或将相关资源用于二次商业化打包与分发。

Copyright © 2026 selfr. All Rights Reserved.
